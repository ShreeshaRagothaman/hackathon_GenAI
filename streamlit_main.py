...
async def main():
    if submit_button:
        ...
        input_prompt = f"""
        please provide synthetic data considering I provide the sample data and the context as input. 
        (eg) I'll provide sales data for year 2019. I'll ask you to provide synthetic data for year 2020 considering covid impact on sales.
        {data}
